...
import pickle
from multi_model_join.graph_join_graph import graph_join_table
...
class MultiModelJoin:
    ...
    def __init__(self, first_collection_constructor, collection_constructor_morphism, second_collection_constructor, left = False):
    ...
    def join(self):
        ...
        if type(first_collection) == TableCollection:
            if type(second_collection) == TableCollection:
                result = table_join_table(self.first_collection_constructor, self.collection_constructor_morphism, self.second_collection_constructor)
            elif type(second_collection) == GraphCollection:
                #result = table_join_graph(self.first_collection_constructor, self.collection_constructor_morphism, self.second_collection_constructor)
                result = None
            ...
            if type(second_collection) == TableCollection:
                ...
                #result = graph_join_graph(self.first_collection_constructor, self.collection_constructor_morphism, self.second_collection_constructor)
                result = None
            elif type(second_collection) == TreeCollection:
