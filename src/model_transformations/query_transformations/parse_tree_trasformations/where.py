...
class Where:
    ...
    def __init__(self, where_clause, from_clause):
        ...
        if "ColumnRef" in left_side.keys() and "ColumnRef" in right_side.keys():
            ...
            left_table = get_name_for_alias(self.left.get_alias())
            right_table = get_name_for_alias(self.right.get_alias())
        ...
        #self.from_clause.add_joins(self.joins)
