...
WITH RECURSIVE post_all(
     ...
     WHERE
          ...
          AND m_creationdate BETWEEN '2012-06-01T00:00:00.000+00:00' :: timestamp
          AND '2012-07-01T00:00:00.000+00:00' :: timestamp
     UNION
     ALL
     SELECT
...
FROM
     ...
     LEFT JOIN post_all psa ON (
          ...
          AND psa_creationdate BETWEEN '2012-06-01T00:00:00.000+00:00' :: timestamp
          AND '2012-07-01T00:00:00.000+00:00' :: timestamp
     )
GROUP BY
     p.p_personid,
