-- Note: because of the primary foreign key constraints, the order of the execution matters!
...
\copy message FROM 'ldbc_flatfiles/message_0_0.csv' WITH (FORCE_NOT_NULL ("m_content"),  DELIMITER '|', HEADER, FORMAT csv);
